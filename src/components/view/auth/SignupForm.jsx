            ...
            <div className="p-6 w-full max-w-md">
                <div className='bg-container rounded-2xl border border-stroke  px-6 pt-7 pb-8 mb-4 text-center'>
                    ...
                    <form className="" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input size="large" {...register("password", { required: true, minLength: 8 })} className="mt-3 input-form !bg-container" id="password" type="password" placeholder="type your password" />
                        <ErrorInput error={errors.password} />

                        <input size="large" {...register("confirmPassword", { required: true, minLength: 8 })} className="mt-3 input-form !bg-container" id="password" type="password" placeholder="confirm your password" />
                        ...
                        <p className='text-sm text-subtext my-4'>Already have Account ? <Link href="/auth/signin"><b>Sign-in</b></Link></p>
                    </form>
                    <hr className="hr" />
